...
var Browserify = function (options = {}) {
  ...
  options.watching   = options.watching !== undefined ? options.watching : flag('watch'); // default to --watch
  ...
  options.entries    = options.entries || config.src.js;
